            ...
            public void onClick(View view) {
                if (username.getText().length() != 0 && password.getText().length() != 0) {
                    if (username.getText().toString().equals(ten) && password.getText().toString().equals(mk)) {
                        Toast.makeText(getContext(), "Are you still playing with the bar?", Toast.LENGTH_SHORT).show();
                    } else if (username.getText().toString().equals("two") && password.getText().toString().equals("123")) {
                        Toast.makeText(getContext(), "Are you still playing with the bar?", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(getContext(), "You have failed to login", Toast.LENGTH_SHORT).show();

                    }
                } else {
                    Toast.makeText(getContext(), "You do not enter information", Toast.LENGTH_SHORT).show();
